        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn mb-3">{{$post->title}}</h1>
                    <a href="" class="h5 text-white">Home</a>
                    <i class="fa fa-angle-double-right text-white px-2"></i>
                    <a href="#" class="h5 text-white">{{$post->title}}</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-8">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded mb-5" src="img/detail.jpg" alt="">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="d-flex flex-wrap m-n1">
                            @foreach ($seo_titles as $seo_title )
                            <a href="" class="btn btn-light m-1">{{$seo_title->seo_title}}</a>
                            @endforeach
                        </div>
                    </div>
                    <!-- Tags End -->
