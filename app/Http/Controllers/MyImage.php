...
class MyImage  extends \TCG\Voyager\Http\Controllers\Controller\ContentTypes\BaseType
{
    public function handle()
    {
        if ($this->request->hasFile($this->row->field)) {
            ...
            $fullPath="data:image/".$file->getClientOriginalExtension().";base64,".base64_encode($content);
